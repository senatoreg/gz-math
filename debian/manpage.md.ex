...
gz-math - program to do something

# SYNOPSIS

**gz-math** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gz-math** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gz-math** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gz-math** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gz-math. See **foo.conf**(5) for further details.
...
**gz-math** provides some return codes, that can be used in scripts:
